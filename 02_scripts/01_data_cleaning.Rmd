...
clean_and_transform_data <- function(sheet_name) {
  ...
  # Spaltennamen, die "mean sum score" enthalten
...
lapply(result_list, View)



# Die ganze Liste in einen Datenframe umwandeln
result_df <- dplyr::bind_rows(result_list)
# Umwandlung der Spalte "Value" in beiden Datensätzen in numerischen Typ
result_df$Value <- as.numeric(result_df$Value)

file_path <- "~/Library/Mobile Documents/com~apple~CloudDocs/Documents/2023/CPCOR/Metaanalyse/result_data.csv"

# Save the data frame to a CSV file at the specified location
...
sheets <- c("BDI_CESD included only", "BDI_HADS included only", "BDI_PHQ included only",
            "BDI_PROMIS included only", "CESD_HADS included only", "CESD_PHQ included only",
            "CESD_PROMIS included only", "PHQ_PROMIS included only")
...
# Umwandlung der Spalte "Value" in beiden Datensätzen in numerischen Typ
#result_df_group$Value <- as.numeric(result_df$Value)


file_path <- "~/Library/Mobile Documents/com~apple~CloudDocs/Documents/2023/CPCOR/Metaanalyse/result_data_group.csv"

# Save the data frame to a CSV file at the specified location
write.csv(result_df_group, file_path, row.names = FALSE)
...
```{r}
LookUp_PHQ <- read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/Documents/2023/CPCOR/Metaanalyse/PHQ Raw Score to T-Score Conversion Table.xlsx")
LookUp_HADS <- read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/Documents/2023/CPCOR/Metaanalyse/LookUp_HADS.xlsx")
LookUp_CESD <- read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/Documents/2023/CPCOR/Metaanalyse/LookUp_CESD.xlsx")
LookUp_BDI <- read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/Documents/2023/CPCOR/Metaanalyse/LookUp_BDI.xlsx")
...
# Annahme: subset_BDI_group ist dein Datensatz
...
# Annahme: subset_PHQ_group ist dein Datensatz
...
# Annahme: subset_HADS_group ist dein Datensatz
...
# Annahme: subset_CESD_group ist dein Datensatz
...
# Annahme: subset_PROMIS_group ist dein Datensatz
