...
setwd("~/Library/Mobile Documents/com~apple~CloudDocs/Documents/2023/CPCOR/Git/MetaanalysisCommonMetrics/02_scripts")
...
system("git config --global user.name 'MiaGrote'")
system("git config --global user.email 'mia.grote@online.de'")
```
